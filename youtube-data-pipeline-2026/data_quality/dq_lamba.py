...
# Explicit S3 output path — avoids awswrangler trying to auto-discover/create
# a default Athena results bucket, which was causing the BucketExists waiter to fail.
ATHENA_S3_OUTPUT = os.environ.get(
    "ATHENA_S3_OUTPUT",
    "s3://yt-glue-athena-query-584342047171-ap-southeast-1-an/dq-checks/"
)
